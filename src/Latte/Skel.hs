...
transProgram x = case x of
  Latte.Abs.ProgramT _ topdefs -> failure x

transTopDef :: Show a => Latte.Abs.TopDef' a -> Result
transTopDef x = case x of
  Latte.Abs.FnDef _ type_ ident args block -> failure x
  Latte.Abs.ClDef _ ident clblock -> failure x
  Latte.Abs.SubClDef _ ident1 ident2 clblock -> failure x

transArg :: Show a => Latte.Abs.Arg' a -> Result
transArg x = case x of
  Latte.Abs.ArgT _ type_ ident -> failure x

transClBlock :: Show a => Latte.Abs.ClBlock' a -> Result
transClBlock x = case x of
  Latte.Abs.ClBlockT _ incldefs -> failure x

transInClDef :: Show a => Latte.Abs.InClDef' a -> Result
transInClDef x = case x of
  Latte.Abs.MthDef _ type_ ident args block -> failure x
  Latte.Abs.FldDef _ type_ ident -> failure x

transBlock :: Show a => Latte.Abs.Block' a -> Result
transBlock x = case x of
  Latte.Abs.BlockT _ stmts -> failure x
...
transStmt x = case x of
  ...
  Latte.Abs.Ass _ expr1 expr2 -> failure x
...
transType x = case x of
  ...
  Latte.Abs.Arr _ type_ -> failure x
  Latte.Abs.Cl _ ident -> failure x
...
transExpr x = case x of
  ...
  Latte.Abs.ECastId _ expr -> failure x
  Latte.Abs.ECastArr _ type_ -> failure x
  Latte.Abs.ECast _ type_ -> failure x
  Latte.Abs.EFun _ ident exprs -> failure x
  Latte.Abs.EMth _ expr ident exprs -> failure x
  Latte.Abs.EInd _ expr1 expr2 -> failure x
  Latte.Abs.EAcc _ expr ident -> failure x
  Latte.Abs.ENew _ type_ -> failure x
  Latte.Abs.ENewArr _ type_ expr -> failure x
